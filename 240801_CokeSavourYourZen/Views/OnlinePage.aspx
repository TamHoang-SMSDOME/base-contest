...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    <img src="../Content/images/Web Banner.jpg" alt="Online Submission" style="width: 100%;">
    <p>
        &nbsp;
    ...
    <p class="paragraph">
        Spend $5 on Participating Brands or Purchase 2 cans / bottles of Participating Brands and stand a chance to win a Portable Theatre System.* <br />
        <strong>1st Prize:</strong> Sony Portable Theatre System (worth $769) x 10 Winners   <br />
      <strong>2nd Prize:</strong> Salt Room Facial Experience at Pablo Blau (worth $380) x 25 Winners <br />
        <strong>Consolation Prize:</strong> Grab e-vouchers (worth $10) x 200 Winners <br /><br />

        *Terms and Conditions Apply. Please refer to <asp:HyperLink runat="server" NavigateUrl="~/Content/TnCs.pdf" Target="_blank" Text="T&Cs" /> for retailer’s participating mechanic.
    </p>
    ...
    <label>
        ...
        <span style="width: 50%">I acknowledge that I have read and understood the 
           <asp:HyperLink runat="server" NavigateUrl="~/Content/TnCs.pdf" Target="_blank" Text="Terms & Conditions" />
            and the 
           <asp:HyperLink runat="server" NavigateUrl="https://www.coca-cola.com/sg/en/legal/privacy-policy" Target="_blank" Text="Privacy & Cookie Policy" />, and consent to the collection, use and disclosure of my personal data by Coca-Cola Singapore for the purposes set out therein.</span>
    </label>
    <p>
        &nbsp;
