...
namespace BaseContest_WebForms.Models
{
    public class Constants
    {
        ...
        /*
    public BC_240801_COKESAVOURYOURZEN_Settings GetSettings() {
        using (var db = new BaseEntities()) {
            return db.BC_240801_COKESAVOURYOURZEN_Settings.FirstOrDefault();
        }
    }
    ...
    {
        using (var db = new BaseEntities()) {
            db.BC_240801_COKESAVOURYOURZEN_Settings.Add(new BC_240801_COKESAVOURYOURZEN_Settings()
            {
                Keyword = "TEST",
